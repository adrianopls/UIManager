# -*- coding: utf-8 -*-
"""
Created on Mon Feb 28 11:45:05 2022
...
class ImagePlotController(WorkPageController):
    tid = 'imageplot_controller'
...
class ImagePlot(WorkPage):
    ...
    def PostInit(self):
        logging.debug("ImagePlot.PostInit")
        try:
            ...
            canvas_controller = UIM.create('canvas_plotter_controller',
                                            ...
                                            xaxis_labeltext = "Pixels X axis",
                                            yaxis_labeltext = "Pixels Y axis"
            )
            #
...
#                                                     self.on_canvas_mouse_move)
            ...
            print ('ERROR IN ImagePlot.PostInit:', e)
            raise
