...
class WaveletPlotController(WorkPageController):
    tid = 'waveletplot_controller'
    ...
    def PostInit(self):
        ...
        try:
            ...
            canvas_controller = UIM.create('canvas_plotter_controller',
                                            ...
                                            xaxis_labeltext = "Time (seconds)",
                                            yaxis_labeltext = "Amplitude"
            )
            #
